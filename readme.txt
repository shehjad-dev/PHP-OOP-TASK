...
Step-4: We need to change the ROOT_URL 
        To do that go to config/rooturlconfig.php
        and change the 2nd parameter of the constant with this "http://localhost/PHP-OOP-TASK-master/"
        
Step-5: Now go to step-1 if you have not downloaded the code
...
Step-7: Details about the project
